...
/* Command for C compiler:
   gcc -c  -w  -I/home/dotharaai/.choosenim/toolchains/nim-0.13.0/lib -o /home/dotharaai/projects/nim/ABC169/nimcache/stdlib_parseutils.o /home/dotharaai/projects/nim/ABC169/nimcache/stdlib_parseutils.c */
...
STRING_LITERAL(TMP232, "overflow", 8);
	...
	nimln(203, "parseutils.nim");
	{
		...
		(*b) = IL64(0);
		{
			...
			while (1) {
				...
				TMP225 = mulInt64((*b), IL64(10));
				if ((NU)(i) > (NU)(s->Sup.len)) raiseIndexError();
				TMP226 = subInt(((NI) (((NU8)(s->data[i])))), ((NI) 48));
				TMP227 = subInt64((NI64)(TMP225), ((NI64) ((NI)(TMP226))));
				(*b) = (NI64)(TMP227);
				nimln(207, "parseutils.nim");
				TMP228 = addInt(i, ((NI) 1));
				i = (NI)(TMP228);
				{
...
N_NIMCALL(NI, npuParseInt)(NimStringDesc* s, NI* number, NI start) {
	...
	nimln(231, "parseutils.nim");
	{
		...
		LOC9 = 0;
		LOC9 = (*e_93841).Sup.Sup.message; (*e_93841).Sup.Sup.message = copyStringRC1(((NimStringDesc*) &TMP232));
