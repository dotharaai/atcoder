...
/* Command for C compiler:
   gcc -c  -w  -I/home/dotharaai/.choosenim/toolchains/nim-0.13.0/lib -o /home/dotharaai/projects/nim/ABC169/nimcache/stdlib_strutils.o /home/dotharaai/projects/nim/ABC169/nimcache/stdlib_strutils.c */
...
STRING_LITERAL(TMP233, "invalid integer: ", 17);
...
appendString(LOC7, ((NimStringDesc*) &TMP233));
appendString(LOC7, s);
...
N_NIMCALL(NIM_CHAR, nsuToLowerChar)(NIM_CHAR c) {
	...
	nimln(198, "strutils.nim");
	{
		...
		TMP235 = addInt(((NI) (((NU8)(c)))), ((NI) 32));
		result = ((NIM_CHAR) (((NI)chckRange((NI)(TMP235), ((NI) 0), ((NI) 255)))));
	}
	goto LA1;
	LA3: ;
	{
...
N_NIMCALL(NimStringDesc*, nsuToLowerStr)(NimStringDesc* s) {
	...
	result = mnewString(((NI)chckRange((s ? s->Sup.len : 0), ((NI) 0), ((NI) IL64(9223372036854775807)))));
	{
		...
		TMP234 = subInt((s ? s->Sup.len : 0), ((NI) 1));
		HEX3Atmp_96446 = (NI)(TMP234);
...
{	result = 0;
	...
	m = (((a ? a->Sup.len : 0) <= (b ? b->Sup.len : 0)) ? (a ? a->Sup.len : 0) : (b ? b->Sup.len : 0));
	{
		...
		while (1) {
			...
			TMP245 = subInt(((NI) (((NU8)(LOC3)))), ((NI) (((NU8)(LOC4)))));
			result = (NI)(TMP245);
			...
			TMP246 = addInt(i, ((NI) 1));
			i = (NI)(TMP246);
		} LA2: ;
	}
	nimln(274, "strutils.nim");
	TMP247 = subInt((a ? a->Sup.len : 0), (b ? b->Sup.len : 0));
	result = (NI)(TMP247);
	}BeforeRet: ;
	popFrame();
	return result;
...
N_NIMCALL(NIM_CHAR, nsuToUpperChar)(NIM_CHAR c) {
	...
	nimln(221, "strutils.nim");
	{
		...
		TMP285 = subInt(((NI) (((NU8)(c)))), ((NI) 32));
		result = ((NIM_CHAR) (((NI)chckRange((NI)(TMP285), ((NI) 0), ((NI) 255)))));
	}
	goto LA1;
	LA3: ;
	{
...
N_NIMCALL(NimStringDesc*, nsuToUpperStr)(NimStringDesc* s) {
	...
	result = mnewString(((NI)chckRange((s ? s->Sup.len : 0), ((NI) 0), ((NI) IL64(9223372036854775807)))));
	{
		...
		TMP284 = subInt((s ? s->Sup.len : 0), ((NI) 1));
		HEX3Atmp_96510 = (NI)(TMP284);
		nimln(1874, "system.nim");
		res_96513 = ((NI) 0);
		{
			nimln(1875, "system.nim");
