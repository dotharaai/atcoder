...
/* Command for C compiler:
   gcc -c  -w  -I/home/dotharaai/.choosenim/toolchains/nim-0.13.0/lib -o /home/dotharaai/projects/nim/ABC169/nimcache/stdlib_algorithm.o /home/dotharaai/projects/nim/ABC169/nimcache/stdlib_algorithm.c */
#define NIM_INTBITS 64

#include "nimbase.h"
static N_INLINE(NI, HEX2A_102008)(NI x, NU8 order);
...
static N_INLINE(NI, HEX2A_102008)(NI x, NU8 order) {
	...
	TMP146 = subInt(((NI) (order)), ((NI) 1));
	y = (NI)(TMP146);
	nimln(25, "algorithm.nim");
	TMP147 = subInt((NI)(x ^ ((NI) (y))), ((NI) (y)));
	result = (NI)(TMP147);
	popFrame();
	return result;
}
