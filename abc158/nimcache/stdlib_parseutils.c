...
/* Command for C compiler:
   gcc -c  -w  -I/home/dotharaai/.choosenim/toolchains/nim-0.13.0/lib -o /home/dotharaai/projects/nim/abc158/nimcache/stdlib_parseutils.o /home/dotharaai/projects/nim/abc158/nimcache/stdlib_parseutils.c */
...
STRING_LITERAL(TMP176, "overflow", 8);
	...
	nimln(203, "parseutils.nim");
	{
		...
		(*b) = IL64(0);
		{
			...
			while (1) {
				...
				TMP169 = mulInt64((*b), IL64(10));
				if ((NU)(i) > (NU)(s->Sup.len)) raiseIndexError();
				TMP170 = subInt(((NI) (((NU8)(s->data[i])))), ((NI) 48));
				TMP171 = subInt64((NI64)(TMP169), ((NI64) ((NI)(TMP170))));
				(*b) = (NI64)(TMP171);
				nimln(207, "parseutils.nim");
				TMP172 = addInt(i, ((NI) 1));
				i = (NI)(TMP172);
				{
		...
		TMP174 = mulInt64((*b), sign);
		(*b) = (NI64)(TMP174);
		nimln(210, "parseutils.nim");
		TMP175 = subInt(i, start);
		result = (NI)(TMP175);
	}
	LA10: ;
	popFrame();
...
N_NIMCALL(NI, npuParseInt)(NimStringDesc* s, NI* number, NI start) {
	...
	nimln(231, "parseutils.nim");
	{
		...
		LOC9 = 0;
		LOC9 = (*e_94841).Sup.Sup.message; (*e_94841).Sup.Sup.message = copyStringRC1(((NimStringDesc*) &TMP176));
